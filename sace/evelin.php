...
$sqlcmd = "select count(*) as cantidad, DATE_FORMAT(fecha_creacion, '%Y-%m-%d') as fc from datos_personales where operador_creacion='evelin' group by fc order by fc ";
...
$sqlcmd = "select count(*) as cantidad, DATE_FORMAT(fecha_modificacion, '%Y-%m-%d') as fm from datos_personales where operador_modificacion='evelin' group by fm order by fm ";
