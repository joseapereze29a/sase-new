...
$sqlcmd = "SELECT count(*) as cantidad, DATE_FORMAT(fecha_creacion, '%Y-%m-%d') as fc from record_notas where operador_creacion='mariela' group by fc order by fc ";
...
$sqlcmd = "SELECT count(*) as cantidad, DATE_FORMAT(fecha_modificacion, '%Y-%m-%d') as fm from record_notas where operador_modificacion='mariela' group by fm order by fm ";
