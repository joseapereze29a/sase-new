...
<FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
	Seleccione una Cohorte existente para <B>Editar sus Actas</B> (Notas),<BR>
	o para Editar los <B>Datos de la Cohorte</B>
</FONT>
...
<TR>
	...
	<TD WIDTH="70" ALIGN="left" VALIGN="top" BGCOLOR="#000099">
		<P> </P>
	</TD>
	<TD WIDTH="140" ALIGN="center" VALIGN="top" BGCOLOR="#000099">
		<FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
			<B>Periodo Lectivo</B>
		</FONT>
	</TD>
	...
	<TD WIDTH="140" ALIGN="right" VALIGN="top" BGCOLOR="#000099">
		<P> </P>
	</TD>
</TR>
<?
...
?>
	<TR>
		...
		<TD WIDTH="70" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
			<A HREF="seleccion_acta.php?_codcohorte=<? echo $codcohorte ?>">
				<FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#0000FF"><B>Actas</B></FONT></A>

		</TD>
		<TD WIDTH="140" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
			<FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
		...
		<TD WIDTH="140" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
			<A HREF="edicion_cohorte.php?_codsede=<? echo $_codsede ?>&_codopest=<? echo $_codopest ?>&_codcohorte=<? echo $codcohorte ?>">
				<FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#0000FF"><B>Editar Cohorte</B></FONT></A>
		</TD>
	</TR>
<?
}
