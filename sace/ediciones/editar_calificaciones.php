...
<TR>
	<TD WIDTH="100%" ALIGN="left" VALIGN="top">
		...
		<A HREF="editando_datos_acta.php?_codacta=<? echo $codacta ?>&_codcohorte=<? echo $codcohorte ?>"><FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#000000"><B>Edici&oacute;n de Acta</B></FONT></A>
...
<TR>
	<TD WIDTH="120" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<A HREF="editando_calificaciones.php?codacta=<? echo $codacta ?>&_cedula=<? echo $cedula ?>">
