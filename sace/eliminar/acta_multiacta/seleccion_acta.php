...
<FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
	<B>El Acta y las Notas que la Conforman ser&aacute;n Eliminadas.</B>
</FONT>
...
<TR>
	<TD WIDTH="110" ALIGN="center" VALIGN="top" BGCOLOR="#000099">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
			<B>Acta</B>
		</FONT>
	</TD>
	<TD WIDTH="190" ALIGN="left" VALIGN="top" BGCOLOR="#000099">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
			<B>Profesor</B>
		</FONT>
	</TD>
	<TD WIDTH="291" ALIGN="left" VALIGN="top" BGCOLOR="#000099">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
			<B>Asignatura</B>
		</FONT>
	</TD>
...
<TR>
	<TD WIDTH="110" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<A HREF="javascript:popup('_blank', '/sace/ingresos/detalle_acta.php?codacta=<? echo $codacta ?>',640,510)"><FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#3300FF"><B>Ver</B></FONT></A><FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
		&nbsp;</FONT><A HREF="eliminar_acta.php?codacta=<? echo $codacta ?>"><FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FF0000"><B>ELIMINAR</B></FONT></A>
	</TD>
	<TD WIDTH="190" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
			<? echo $apellidos_nombres ?>
		</FONT>
	</TD>
	<TD WIDTH="291" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
			<? echo $asignatura ?>
		</FONT>
	</TD>
...
?>
			<TR>
				<TD WIDTH="101" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
					<A HREF="javascript:popup('_blank', '/sace/ingresos/detalle_multiacta.php?codacta=<? echo $codacta ?>&mid=<? echo $mid ?>',650,350)"><FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#3300FF"><B>Ver</B></FONT></A><FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
					&nbsp;</FONT><A HREF="eliminar_multiacta.php?codacta=<? echo $codacta ?>&mid=<? echo $mid ?>"><FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FF0000"><B>ELIMINAR</B></FONT></A>
				</TD>
