<?
###
###		Este script Elimina una Multiacta seleccionada y todas las notas que contenga esa Multiacta.
###

###
### Debe haber un (codacta) y un (mid) para saber que voy a Eliminar, sino voy a la pagina principal de Eliminar.
###
...
###
### Si me estan pasando el (codacta) y el (mid) es por que deben de existir, verifico en la DB 
...
if ($cantidad_multiactas_encontrada <= 0)
{
	$url= '/sace/eliminar/';
	header ("Location: $url");
	exit;
...
###
### El Multiacta existe como tal, asi que antes de Eliminarla, copio sus Datos a la Tabla "eliminaciones_multiactas"
### Si del Multiacta existen Notas, copio las Notas a la Tabla "eliminaciones_notas" antes de Borrarlas
###


### Busco los Datos que tenga el Multiacta
...
###
### Si existe el Multiacta la Elimino, y Todas sus Notas
###

if ($cantidad_multiactas_encontrada > 0)
{

	### Elimino el Multiacta como tal
