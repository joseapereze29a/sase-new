...
<FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
	Seleccione un Acta existente para visualizarla la Nota
</FONT>
...
<TR>
	<TD WIDTH="50" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<A HREF="seleccion_estudiante_acta.php?codacta=<? echo $codacta ?>">
			<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#3300FF">
				<B>Ver</B>
			</FONT>
		</A>
		</FONT></TD>
	<TD WIDTH="230" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
			<? echo $apellidos_nombres ?>
		</FONT>
	</TD>
	<TD WIDTH="311" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
			<? echo $asignatura ?>
		</FONT>
	</TD>
...
?>
			<TR>
				<TD WIDTH="50" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
					<A HREF="seleccion_estudiante_multiacta.php?codacta=<? echo $codacta ?>&mid=<? echo $mid ?>">
						<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#3300FF">
							<B>Ver</B>
						</FONT>
					</A>
					</FONT></TD>
				<TD WIDTH="197" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
					<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
