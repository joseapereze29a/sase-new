...
<TR>
	<TD WIDTH="100%" ALIGN="left" VALIGN="top">
		...
		<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#000000"><B>Detalle de Multiacta</B></FONT>
...
<?
$sqlcmd = "SELECT cedula, calificacion, codeq "
		. "FROM record_notas "
...
<TR>
	<TD WIDTH="70" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<A HREF="eliminar_nota.php?codacta=<? echo $codacta ?>&cedula=<? echo $cedula ?>&mid=<? echo $mid ?>"><FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FF0000"><B>ELIMINAR</B></FONT></A></TD>
