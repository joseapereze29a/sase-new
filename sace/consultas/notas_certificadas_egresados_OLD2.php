...
<TR>
	<TD WIDTH="120" ALIGN="center" VALIGN="middle" ROWSPAN="2">
		...
		<A HREF="/sace/consultas/consulta_por_cedula.php?cedula=<? echo $cedula ?>"><IMG SRC="/sace/imagenes/logo.jpg" ALT="" WIDTH="60" HEIGHT="50" BORDER="0"></A>
...
### Reviso si voy a Imprimir la Materia con la Nota o No
		...
		if ($imprimo_nota)
		{
			...
			if ($periodo_actual != $periodos)
			{
				...
				echo '<TR><TD COLSPAN="6" BGCOLOR="#FFFFFF"><BR></TD></TR>';
			}
?>
<TR>
	...
	<TD WIDTH="60" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<FONT SIZE="-1" FACE="Arial">
			<? echo $creditos ?>
		</FONT>
	</TD>
	...
	<TD WIDTH="140" ALIGN="right" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
		<FONT SIZE="-1" FACE="Arial">
