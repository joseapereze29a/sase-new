        ...
        ?>
            ...
            <TABLE BORDER="0" WIDTH="700" CELLSPACING="10" CELLPADDING="2">
                <TR>
                    ...
                    <TD WIDTH="100" ALIGN="center" VALIGN="top" BGCOLOR="#0066FF">
                        <A HREF="detalle_datos_personales.php?cedula=<? echo $cedula ?>">
            ...
            ?>
                    ...
                    <TR>
                            ...
                            <TABLE BORDER="0" WIDTH="120" CELLSPACING="2" CELLPADDING="2">
                                <TR>
                                    <TD WIDTH="120" ALIGN="center" VALIGN="top" BGCOLOR="#0066FF">
                                        <A HREF="notas_certificadas.php?cedula=<? echo $cedula ?>&codcohorte=<? echo $codcohorte[$i] ?>">
                                            <FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
                                                <B>Notas Simples</B>
                                            </FONT>
                                        </A>
                            ...
                            <TABLE BORDER="0" WIDTH="200" CELLSPACING="2" CELLPADDING="2">
                                <TR>
                                    <TD WIDTH="200" ALIGN="center" VALIGN="top" BGCOLOR="#0066FF">
                                        <A HREF="notas_certificadas_egresados.php?cedula=<? echo $cedula ?>&codcohorte=<? echo $codcohorte[$i] ?>">
                                            <FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
                        ...
                        <TD WIDTH="100" ALIGN="left" VALIGN="top">
                            ...
                            <TABLE BORDER="0" WIDTH="100" CELLSPACING="2" CELLPADDING="2">
                                <TR>
                                    <TD WIDTH="100" ALIGN="center" VALIGN="top" BGCOLOR="#0066FF">
                                        <A HREF="detalle_de_calificaciones.php?cedula=<? echo $cedula ?>&codcohorte=<? echo $codcohorte[$i] ?>">
                                            <FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF">
                                                <B>Ver mas detalle</B>
                                            </FONT>
                                        </A>
                ...
                <TABLE BORDER="0" WIDTH="700" CELLSPACING="1" CELLPADDING="2" BGCOLOR="#000099">
                    <TR>
                        <TD WIDTH="100" ALIGN="left" VALIGN="top">
                            <A HREF="consulta_por_cedula.php?cedula=<? echo $cedula ?>&_orden=codasig">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF"><B>Codigo</B></FONT>
                            </A>
                        </TD>
                        <TD WIDTH="350" ALIGN="left" VALIGN="top">
                            <A HREF="consulta_por_cedula.php?cedula=<? echo $cedula ?>&_orden=asignatura">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF"><B>Asignatura</B></FONT>
                            </A>
                        </TD>
                        <TD WIDTH="100" ALIGN="center" VALIGN="top">
                            <A HREF="consulta_por_cedula.php?cedula=<? echo $cedula ?>&_orden=calificacion">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF"><B>Nota</B></FONT>
                            </A>
                        </TD>
                        <TD WIDTH="150" ALIGN="right" VALIGN="top">
                            <A HREF="consulta_por_cedula.php?cedula=<? echo $cedula ?>&_orden=fecha_aprobacion">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#FFFFFF"><B>Fecha Aprobacion</B></FONT>
                            </A>
                        </TD>
                    </TR>
                    <?
                    ...
                    ?>
                        <TR>
                            <TD WIDTH="100" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" <? if (($calificacion >= 1) && ($calificacion <= 14)) echo 'COLOR="#3300FF"'; ?>>
                                    <? echo $codasig_imp ?>
                                </FONT>
                            </TD>
                            <TD WIDTH="350" ALIGN="left" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" <? if (($calificacion >= 1) && ($calificacion <= 14)) echo 'COLOR="#3300FF"'; ?>>
                                    <?
                            ...
                            <TD WIDTH="100" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva" <? if (($calificacion >= 1) && ($calificacion <= 14)) echo 'COLOR="#3300FF"><B>'; ?>><? echo $calificacion ?></FONT>
                            </TD>
                            <TD WIDTH="150" ALIGN="right" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
                                <FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
                ...
                <TABLE BORDER="0" WIDTH="600" CELLSPACING="1" CELLPADDING="2">
                    <TR>
                        <TD WIDTH="600" ALIGN="center" VALIGN="top">
                            <FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
                                <B>Índice Académico: <? echo number_format(($notas / $total_creditos), 2, ',', '') ?></B>
                            </FONT>
                        </TD>
                    </TR>
                </TABLE>
