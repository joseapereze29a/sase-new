...
*/
	#echo "$sqlcmd<BR>";
/*
mysql> select * from pensum_estudios where codsede='PPAL' AND pensum_estudios.codopest='MC-OC';
+---------+----------+---------+-------------------------------------------+----------+----------+--------+-------------+-----------+
| codsede | codopest | codasig | asignatura                                | creditos | periodos | status | codasig_imp | multiacta |
+---------+----------+---------+-------------------------------------------+----------+----------+--------+-------------+-----------+
| PPAL    | MC-OC    | OC-001  | Formaci—n de Actitudes del Orientador I   |        1 |        1 | Activa | OC-001      | no        |
| PPAL    | MC-OC    | OC-002  | Formaci—n de Actitudes del Orientador II  |        2 |        2 | Activa | OC-002      | no        |
...
*/
	...
	$sqlcmd = "SELECT codasig, asignatura, creditos, periodos, codasig_imp "
			...
			. "WHERE codsede='$codsede' AND pensum_estudios.codopest='$codopest' "
