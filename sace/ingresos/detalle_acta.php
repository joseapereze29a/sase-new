...
$cantidad_por_pagina = "15";	### Muestro de Tantos en Tantos Alumnos por Listado
...
*/
		...
		if ($contador > 0) {
			...
			$sqlcmd = "SELECT (SUM(calificacion)/count(calificacion)) AS promedio "
				. "FROM record_notas "
				. "WHERE calificacion>0 AND calificacion<=20 AND codacta='$codacta' ";
		...
		?>
			...
			<TABLE BORDER="0" WIDTH="600" CELLSPACING="0" CELLPADDING="2">
				<TR>
					<TD WIDTH="150" ALIGN="left" VALIGN="top" BGCOLOR="#CCCCCC">
						<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
							...
							if ($_desde > 0) {
								...
								echo '&lt;- <A HREF="detalle_acta.php?_desde=' . $nuevo_desde . '&codacta=' . $codacta . '">Anteriores</A>';
							} else {
								echo '&lt;- Anteriores';
							}
							?>
					...
					<TD WIDTH="300" ALIGN="center" VALIGN="top" BGCOLOR="#CCCCCC">
						<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
							<?
					...
					<TD WIDTH="150" ALIGN="right" VALIGN="top" BGCOLOR="#CCCCCC">
						<FONT SIZE="-2" FACE="Verdana,Arial,Geneva">
							<?
							if ($mostrar_fin < $contados) {
								echo '<A HREF="detalle_acta.php?_desde=' . $mostrar_fin . '&codacta=' . $codacta . '">Siguientes</A> -&gt;';
							} else {
								echo 'Siguientes -&gt;';
							}
							?>
