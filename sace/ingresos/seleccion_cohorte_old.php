...
###
session_start();
echo $_codopest = $_POST['_codopest'];
echo $_codsede = $_SESSION['_codsede'];
...
<FONT SIZE="-1" FACE="Verdana,Arial,Geneva">
	Seleccione una Cohorte existente o ingrese una </FONT>
	<A HREF="ingreso_cohorte.php?_codsede=<? echo $_codsede ?>&_codopest=<? echo $_codopest ?>">
		<FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#0000FF"><B>Cohorte Nueva</B></FONT></A>
</FONT>
...
?>
		<TR>
			...
			<TD WIDTH="150" ALIGN="center" VALIGN="top" BGCOLOR="<? echo $bg_celda ?>">
				<A HREF="seleccion_acta.php?_codcohorte=<? echo $codcohorte ?>">
					<FONT SIZE="-1" FACE="Verdana,Arial,Geneva" COLOR="#0000FF"><B><? echo "Seleccionar" #$codcohorte ?></B></FONT></A>
			</TD>
