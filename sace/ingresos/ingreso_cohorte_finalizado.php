		...
		<TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="1">
			<TR>
				<TD WIDTH="100%" ALIGN="left" VALIGN="top">
					...
					<FONT SIZE="-2" FACE="Verdana,Arial,Geneva" COLOR="#000000"><B>Creaci&oacute;n de la Cohorte Finalizado</B></FONT>
				</TD>
			</TR>
		</TABLE>
			...
			<TR>
				<TD WIDTH="600" ALIGN="center" VALIGN="top">
					<FONT FACE="Verdana,Arial,Geneva" COLOR="#000099">
						<B>La Cohorte ha sido<BR>Creada Satisfactoriamente.</B>
					</FONT>

					<BR><BR><BR><BR>

					<FONT FACE="Verdana,Arial,Geneva">
						Presione <A HREF="seleccion_cohorte.php?_codsede=<? echo $_GET['_codsede']  ?>&_codopest=<? echo $_GET['_codopest'] ?>">Aqu&iacute;</A> para Continuar.
					</FONT>
				</TD>
			</TR>
		</TABLE>
